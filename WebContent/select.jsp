...
<body>
	...
	<div id="back"><a href="pres.do?back=back&id=${president.termNumber}">&lt</a></div>
	<div id="next"><a href="pres.do?next=next&id=${president.termNumber}">&gt</a></div>
    ...
    <div id="presidentInfo">
		...
		<a href="getPresident.do?id=${president.termNumber }"><img style="width: 20%;"src="PresPics/${president.picture }" /></a>
</c:forEach>
 --%>
  	<a href="getPresident.do?id=${president.termNumber }"><img style="width: 20%;"src="PresPics/${president.picture }" /></a>
